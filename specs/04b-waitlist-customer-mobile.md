...
### Done When
- [x] Join Waitlist CTA visible on each service in business detail
- [x] 409 already-on-waitlist surfaced as toast
- [x] Waitlist tab lists entries with correct status badges
- [x] ACTIVE row Leave action removes the entry
- [x] PROMOTED row Book Now navigates to appointment request form pre-filled with serviceId
