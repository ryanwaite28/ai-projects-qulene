...
- [ ] PENDING rows show Accept + Decline; clicking succeeds + updates row
- [ ] Past ACCEPTED rows show Complete + No-Show
- [ ] Cards render correctly with NativeWind
- [ ] Empty state + loading skeleton + pull-to-refresh
